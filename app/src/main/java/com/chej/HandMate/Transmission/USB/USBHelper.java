...
public class USBHelper {
    ...
    private USBHelper.ReceiveHandler receiveHandler = new USBHelper.ReceiveHandler();
    private USBHelper.BackHandler backHandler=new USBHelper.BackHandler();
            ...
            if (msg.what == 1) {
                ...
                for (int ff = 0; ff < strFF.length; ff++)
                {
                    ...
                    if(str[0].equals("25"))//GCU向AWS发送配置报文请求。
                    {
                        ...
                        sendData(messages.dConfigData(data));
                    }
    ...
    private void receiverData(int flag) {
        ...
        if (flag == 2) {
            ...
            receiverThread = new Thread(new USBHelper.MyReceiverRunnable());
    ...
    public void sendData(byte[] data) {
        USBHelper.MySendRunnable mySendRunnable1=new USBHelper.MySendRunnable(data);
    ...
    public void sendExercise(byte[] data) {
        USBHelper.MySendRunnable mySendRunnable=new USBHelper.MySendRunnable(data);
